...
export function Nav(): ReactNode {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-1 rounded-full bg-surface-primary/90 backdrop-blur-md p-1.5 shadow-sm border border-border">
        <ul ref={listRef} className="relative flex items-center gap-1">
          {pillRect && (
            <motion.span
              ...
              className="absolute rounded-full bg-accent-soft ring-1 ring-accent/35"
            />
          )}
