          ...
          <motion.div
            ...
            style={{
              background: useTransform(
                [spotX, spotY],
                ([x, y]) =>
                  `radial-gradient(500px circle at ${x} ${y}, rgba(164,135,85,0.03) 0%, rgba(200,200,198,0.018) 40%, transparent 70%)`
              ),
            }}
          />
          ...
          <div className="relative z-10 flex flex-col gap-12 sm:gap-16 md:gap-20">
            ...
            <div>
              ...
              >
                ...
                <span className="flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-full border border-border bg-surface-secondary text-foreground transition-all duration-300 group-hover:border-accent/60 group-hover:bg-accent group-hover:text-background-deep dark:border-border dark:bg-surface-elevated">
                  {copied ? (
                ...
                {/* Animated Underline */}
                <span className="absolute bottom-0 left-0 h-[1.5px] w-0 bg-gradient-to-r from-accent to-accent-light transition-all duration-400 ease-out group-hover:w-full" />
              </button>
            </div>
